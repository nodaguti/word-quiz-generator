...
describe('Old Japanese lemmatizer', () => {
  it('can get lemmas of words in normal sentences', async () => {
    await assertOutput({
      ...
      expected: '世 に 宇治 拾遺 物語 と いふ 物 あり 。 こ の 大 納言 は 隆国 と いふ 人 なり 。 西宮 殿 の 孫 、 俊賢 大 納言 の 第 二 の 男 なり 。 と した こし なる て は 、 暑し さ を わぶ て 暇 を 申す て 、 五月 より 八月 まで は 平等 院 一切 経蔵 の 南 の 山ぎは に 、 南泉 房 と いふ 所 に 籠る ゐる らる けり 。 ',
    });
  });
  ...
  it('can properly treat a sentence containing "odoriji"', async () => {
    await assertOutput({
      ...
      expected: '大方 やう 〱 さま 〲 なり 者 ども 、 赤し 色 に は 青し 物 を 着る 、 黒し 色 に は 赤し 物 を 褌 に かく 、 大方 目 一 つ あり 者 あり',
    });
  });
